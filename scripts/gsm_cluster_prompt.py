...
FILE_NAME = datetime.now().strftime("%d-%m-%Y_%H%M%S") + "_" + os.getlogin() + "_" + args.dataset + "_" + args.prompt
OUTPUT_PATH = f'eval_results/Cluster Prompt/{FILE_NAME}.chat.jsonl'
...
template_prompt = open(f"./pal/prompt/Cluster prompt/{args.prompt}.txt", "r").read()
